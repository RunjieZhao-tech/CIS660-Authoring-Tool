...
public:
    ...
    void PolarMoveVerticle(float deg);
    void PolarMoveHorizontal(float deg);
    void PolarZoom(float amt);

    bool RayCast(const glm::vec2 screenpoint,HitInfo* info, const std::vector<Collider*> *colliders);
};
