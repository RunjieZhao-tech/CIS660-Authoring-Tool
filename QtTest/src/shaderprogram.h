...
public:
    ...
    void setBindMatrices(const std::vector<glm::mat4>* bindMats);
    void setTransformMatrices(const std::vector<glm::mat4>* transMats);
    void setDualQuaternions(const std::vector<DualQuat>* qualQuats);
